...
void MSAEditorSequenceArea::sl_changeHighlightScheme(){
    ...
    const MultipleSequenceAlignment &msa = ui->editor->getMSAObject()->getMAlignment();
...
bool MSAEditorSequenceArea::drawContent(QPainter &p, const U2Region &region, const QList<qint64> &seqIdx) {
    ...
    const MultipleSequenceAlignment &msa = maObj->getMAlignment();
...
void MSAEditorSequenceArea::sl_sortByName() {
    ...
    MultipleSequenceAlignment ma = msaObject->getMAlignment();
    ma->sortRowsByName();
