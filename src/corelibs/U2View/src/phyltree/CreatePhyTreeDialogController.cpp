    ...
    saveController(NULL)
{
    ...
    helpPagesMap.insert("PHYLIP Neighbor Joining","17468869");
    helpPagesMap.insert("MrBayes","17468870");
    helpPagesMap.insert("PhyML Maximum Likelihood","17468868");
