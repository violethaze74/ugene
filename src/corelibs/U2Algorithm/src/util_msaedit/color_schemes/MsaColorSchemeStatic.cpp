...
MsaColorSchemeStaticFactory::MsaColorSchemeStaticFactory(QObject *parent, const QString &id, const QString &name, AlphabetFlags &supportedAlphabets, const QVector<QColor> &colorsPerChar)
