...
MsaHighlightingSchemeTransversionsFactory::MsaHighlightingSchemeTransversionsFactory(QObject *parent, const QString &id, const QString &name, QList<DNAAlphabetType> &supportedAlphabetsList)
    : MsaHighlightingSchemeFactory(parent, id, name, supportedAlphabetsList)
{
