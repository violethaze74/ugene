...
public:
    ...
    static void updateConsensus(const MultipleSequenceAlignment& msa, QByteArray& cons, MSAConsensusAlgorithm* algo);

    static void updateConsensus(const MultipleSequenceAlignment& msa, const U2Region& region, QByteArray& cons, MSAConsensusAlgorithm* algo);

    static void updateConsensus(const MultipleSequenceAlignment& msa, const QVector<U2Region>& region, QByteArray& cons, MSAConsensusAlgorithm* algo);

    static QString getConsensusPercentTip(const MultipleSequenceAlignment& msa, int pos, int minReportPercent, int maxReportChars);
    ...
    static quint32 packConsensusCharsToInt(const MultipleSequenceAlignment& msa, int pos, const int* mask4, bool gapsAffectPercents);
    ...
    static uchar getColumnFreqs(const MultipleSequenceAlignment& ma, int pos, QVector<int>& freqsByChar,
