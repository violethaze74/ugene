...
const QString RSupport::ET_R_ID = "UGENE_RSCRIPT";
const QString RModuleGostatsSupport::ET_R_GOSTATS = "GOstats";
const QString RModuleGostatsSupport::ET_R_GOSTATS_ID = "UGENE_GOSTATS";
const QString RModuleGodbSupport::ET_R_GO_DB = "GO.db";
const QString RModuleGodbSupport::ET_R_GO_DB_ID = "UGENE_GO_DB";
const QString RModuleHgu133adbSupport::ET_R_HGU133A_DB = "hgu133a.db";
const QString RModuleHgu133adbSupport::ET_R_HGU133A_DB_ID = "UGENE_HGU133A_DB";
const QString RModuleHgu133bdbSupport::ET_R_HGU133B_DB = "hgu133b.db";
const QString RModuleHgu133bdbSupport::ET_R_HGU133B_DB_ID = "UGENE_HGU133B_DB";
const QString RModuleHgu133plus2dbSupport::ET_R_HGU1333PLUS2_DB = "hgu133plus2.db";
const QString RModuleHgu133plus2dbSupport::ET_R_HGU1333PLUS2_DB_ID = "UGENE_HGU133PLUS2_DB";
const QString RModuleHgu95av2dbSupport::ET_R_HGU95AV2_DB = "hgu95av2.db";
const QString RModuleHgu95av2dbSupport::ET_R_HGU95AV2_DB_ID = "UGENE_HGU95AV2_DB";
const QString RModuleMouse430a2dbSupport::ET_R_MOUSE430A2_DB = "mouse430a2.db";
const QString RModuleMouse430a2dbSupport::ET_R_MOUSE430A2_DB_ID = "UGENE_MOUSE430A2_DB";
const QString RModuleCelegansdbSupport::ET_R_CELEGANS_DB = "celegans.db";
const QString RModuleCelegansdbSupport::ET_R_CELEGANS_DB_ID = "UGENE_CELEGANS_DB";
const QString RModuleDrosophila2dbSupport::ET_R_DROSOPHILA2_DB = "drosophila2.db";
const QString RModuleDrosophila2dbSupport::ET_R_DROSOPHILA2_DB_ID = "UGENE_DROSOPHILA2_DB";
const QString RModuleOrghsegdbSupport::ET_R_ORG_HS_EG_DB = "org.Hs.eg.db";
const QString RModuleOrghsegdbSupport::ET_R_ORG_HS_EG_DB_ID = "UGENE_ORG_HS_EG_DB";
const QString RModuleOrgmmegdbSupport::ET_R_ORG_MM_EG_DB = "org.Mm.eg.db";
const QString RModuleOrgmmegdbSupport::ET_R_ORG_MM_EG_DB_ID = "UGENE_ORG_MM_EG_DB";
const QString RModuleOrgceegdbSupport::ET_R_ORG_CE_EG_DB = "org.Ce.eg.db";
const QString RModuleOrgceegdbSupport::ET_R_ORG_CE_EG_DB_ID = "UGENE_ORG_CE_EG_DB";
const QString RModuleOrgdmegdbSupport::ET_R_ORG_DM_EG_DB = "org.Dm.eg.db";
const QString RModuleOrgdmegdbSupport::ET_R_ORG_DM_EG_DB_ID = "UGENE_ORG_DM_EG_DB";
