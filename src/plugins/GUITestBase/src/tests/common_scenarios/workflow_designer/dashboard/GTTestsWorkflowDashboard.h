...
GUI_TEST_CLASS_DECLARATION_SET_TIMEOUT(output_dir_scanning_test_0005_1, 600000)
GUI_TEST_CLASS_DECLARATION_SET_TIMEOUT(output_dir_scanning_test_0005, 600000)
GUI_TEST_CLASS_DECLARATION_SET_TIMEOUT(output_dir_scanning_test_0006, 600000)
GUI_TEST_CLASS_DECLARATION_SET_TIMEOUT(output_dir_scanning_test_0007, 600000)
GUI_TEST_CLASS_DECLARATION_SET_TIMEOUT(output_dir_scanning_test_0008, 600000)
