...
void CallVariantsWorkerFactory::init() {
    ...
    proto->addExternalTool("BCFTOOLS");//BcfToolsSupport::ET_BCFTOOLS_ID
    proto->addExternalTool("PERL");//PerlSupport::ET_PERL_ID
    proto->addExternalTool("VCF_CONSENSUS");//VcfConsensusSupport::ET_VCF_CONSENSUS_ID
