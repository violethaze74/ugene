...
PLUGIN_DESC_FILE=$$OUT_PWD/../../../$$corelibs_out_dir()/plugins/$${PLUGIN_ID}.plugin
...
unix: system (cat $$PLUGIN_LICENSE_FILE > $$OUT_PWD/../../../$$corelibs_out_dir()/plugins/$${PLUGIN_ID}.license)
