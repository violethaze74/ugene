...
//#exitOnEnding=true
print("Start testing...")
print("Test: setting menu -> User settings, on click radio button another radio button is checked")
...
//UserApplicationSettingsW.groupBox.webBrowserButton
        for (i = 0; i != 2; i++) {
            if (UserApplicationSettingsW.groupBox.defaultWebBrowser.checked) {
                if (UserApplicationSettingsW.groupBox.customWebBrowser.checked) {
                    print("both of WebBrowser RadioButton is checked");
                    throw "both of WebBrowser RadioButton is checked";
                }
                ...
                if (!UserApplicationSettingsW.groupBox.customWebBrowser.checked) {
                    print("customWebBrowser RadioButton is not checked");
                    throw "customWebBrowser RadioButton is not checked";
                }
                if (UserApplicationSettingsW.groupBox.defaultWebBrowser.checked) {
                    print("defaultWebBrowser RadioButton is checked");
                    throw "defaultWebBrowser RadioButton is checked";
                }
            } else {
                if (!UserApplicationSettingsW.groupBox.customWebBrowser.checked) {
                    print("both of WebBrowser RadioButton is  not checked");
                    throw "both of WebBrowser RadioButton is not checked";
                }
                ...
                if (UserApplicationSettingsW.groupBox.customWebBrowser.checked) {
                    print("customWebBrowser RadioButton is checked");
                    throw "customWebBrowser RadioButton is checked";
                }
                if (!UserApplicationSettingsW.groupBox.defaultWebBrowser.checked) {
                    print("defaultWebBrowser RadioButton is not checked");
                    throw "defaultWebBrowser RadioButton is not checked";
                }
            }
        }
//-------------------------------------------------------------------------------------------
