...
print("Start testing...")
print("Test :Testin of project view: add annotation to the begining of mmdb file")
...
regionSelect = function (modalWid) {
    ...
    QTest.mouseMove(curW, pos, main_delay);
    QTest.mouseDClick(curW, 1, 0, pos, main_delay);
    QTest.keyClicks(curW, "10", 0, main_delay);
...
createNewAnnotation = function (modalWid) {
    ...
    if (modalWid.CreateAnnotationWidget.groupBox_2.locationEdit.text != "1..10") {
