...
print("Start testing...")
print("Test :Testin of project view: add annotation to the end of mmdb file")
...
regionSelect = function (modalWid) {
    ...
    QTest.keyClicks(curW, "36", 0, main_delay);

    curW = modalWid.range_selector.end_edit_line;
    QTest.mouseMove(curW, pos, main_delay);
    QTest.mouseDClick(curW, 1, 0, pos, main_delay);
    QTest.keyClicks(curW, "46", 0, main_delay);
...
createNewAnnotation = function (modalWid) {
    ...
    if (modalWid.CreateAnnotationWidget.groupBox_2.locationEdit.text != "36..46") {
