...
print("Start testing...")
print("Test :Testin of project view: add annotation to the midle of gb file")
...
regionSelect = function (modalWid) {
    ...
    QTest.keyClicks(curW, "3000", 0, main_delay);

    curW = modalWid.range_selector.end_edit_line;
    QTest.mouseMove(curW, pos, main_delay);
    QTest.mouseDClick(curW, 1, 0, pos, main_delay);
    QTest.keyClicks(curW, "3600", 0, main_delay);
...
createNewAnnotation = function (modalWid) {
    ...
    if (modalWid.CreateAnnotationWidget.groupBox_2.locationEdit.text != "3000..3600") {
