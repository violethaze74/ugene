...
EXTRA_LIBS_DIR=$BASEDIR/../lib/linux/x86_64
if [ ! -d "$QT_DIR" ]; then
...
echo "copy_qt_files_to_ugene.sh is called for UGENE dir: '$UGENE_DIR', QT_DIR: '$QT_DIR', extra libs dir: $EXTRA_LIBS_DIR"

# QT core libraries.
QT_LIBS=("Core" "DBus" "Gui" "Network" "OpenGL" "PrintSupport" "Script" "ScriptTools" "Sql" "Svg" "Test" "Widgets" "XcbQpa" "Xml")
